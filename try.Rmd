...
col<-brewer.pal(9 ,'Oranges')[c(2,8)]
# Plot!
...
data$`All tests` <- round(data$`All tests` / 1e3, 0); data$Positive <- round(data$Positive / 1e3, 0)
...
# Plot!
config_hc(data$`All tests`, 'areaspline', 'All tests', col[1], 'k') %>%
  hc_add_series(data$Positive, type = 'areaspline',  name = 'Positive tests', color = col[2])
```
...
# Plot!
config_hc(data, 'areaspline', 'Positivity rate', col[1], '%')
```
...
# Plot!
config_hc(data, 'areaspline', 'Cumulative cases', col[1], 'k')
```
...
# Plot!
config_hc(data, 'spline', 'Case fatality ratio', col[1], '%')
```
...
# Plot!
config_hc(series = data$`1st dose`, 'column', '1st dose', col[1], 'k') %>%
