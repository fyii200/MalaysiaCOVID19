...
plot_line(mys$date, mys$new_cases_smoothed)
```
...
7-day average <span style="font-size:0.8em; color:grey;"> *(week ending `r lastlast7avg_date`)*</span>  
<span style="font-size:1.3em"> **`r format(lastlast7avg, scientific = F, big.mark = ',')`** </span>

7-day average <span style="font-size:0.8em; color:grey;"> *(week ending `r last7avg_date`)*</span>  
<span style="font-size:1.3em"> **`r format(last7avg, scientific = F, big.mark = ',')`** </span>
<span style="font-size:1em; color:`r arrowcol`;"> **`r ifelse(weekchange >= 0, print('▲'), print('▼'))`  `r label`**</span>

#### 
```{r echo=FALSE, fig.width=3.5, fig.height=1}
plot_line(test.s$x, test.s$y)
```
...
plot_line(mys$date, mys$new_deaths_smoothed)
```
...
```{r include=FALSE}
# source code file containing computations for daly tests
source('cases/daily_tests.R')
col <- brewer.pal(11 ,'RdYlBu')[c(11, 1)]
```
...
<span style="color:grey;"> *7-day average for the week ending `r last7avg_date`.* </span> 
...
<span style="color:grey;"> *7-day average for the week ending `r lastlast7avg_date`.* </span>
