...
Row {data-height=100}
-----------------------------------------
### <span style="font-size:2.5em;"> Interact with the graphs! </span>
Data are updated daily whenever they become available (date printed on the navigation bar shows when the data were last updated). All graphs (except the few trend lines on the 'Daily Summary' homepage ) on this site are **interactive**. Here are a few tips to help you make the most of thse graphs.

<span style="color:Navy; font-size:1.2em;"> ***First*** </span>, view the graphs on your computer screen whenever possible. You will be able to <span style="color:Navy; font-size:1.2em;"> **hover your cursor over each graph** </span> to see the y-value (e.g., number of vaccinations each day) corresponding to a specific date. You will still be able to do this **if you are using a smartphone**, except that it's no longer 'mouseover' that you're using. Instead, you do this by <span style="color:Navy; font-size:1.2em;"> **tapping** </span> the part of curve/ line of the graph where you want the corresponding y-value to be shown. if the value is not displayed, and you're sure that you're tapping within the plot margins, applying just a little more pressure on your touchscreen might do the trick.

<span style="color:Navy; font-size:1.2em;"> ***Second***,</span> you'll a notice a <span style="color:Navy; font-size:1.2em;"> **horizontal slider** </span> just beneath the x-axis of each graph. Use it to specify the <span style="color:Navy; font-size:1.2em;"> **date range** </span> if you want to zoom in on a particular period of the pandemic. More functions and plots may be added in the near future so keep checking back.

If you're interested in my work and wish to connect with me, or if you have any queries or suggestions, you can contact me through several means (go to my GitHub page via *About me*; contact details are listed there). Happy exploring!  

________________________

#### <span style="font-size:1.5em;"> Data sources </span>
...
### Percentage of minimum target population (23.2m) already vaccinated {.no-mobile}
```{r echo=FALSE}
...
### Percentage of minimum target population (23.2m) already vaccinated {.mobile}
```{r echo=FALSE}
source('summary/squareplot.R')
...
<span style="font-size:1.5em; color:`r col[2]`;"> **+`r death7avg`** </span>  
...
# Plot!
dygraph.plot(data, col, legend.width=140, display='onmouseover', 
...
col <- brewer.pal(9,'Greens')[c(5,9)]
# Plot!
dygraph.plot(data, col, fill=FALSE, dates=d$date, 
...
dygraph.plot(data, col, 
  ...
  dyEvent("2021-04-30", "1", 
          labelLoc = "top", 
          color=event, 'dotted')                      %>%
dyEvent("2021-08-31", "2", 
        labelLoc = "top", 
        color=event, 'dotted')                        %>%
dyEvent("2022-02-28", "                                                     
               3", 
