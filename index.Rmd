...
<span style="color:grey;"> *new 1st doses administered in the past 24 hours.* &nbsp; | &nbsp; *7-day average.* </span>
...
<span style="color:grey;"> *new 2nd doses administered in the past 24 hours.* &nbsp; | &nbsp; *7-day average.* </span>
...
***
Certain countries (including Malaysia) are colour-coded, while others are grey. Each bubble represents a country, with its radius corresponding to the size of that country. Hover your cursor over or tap the bubbles to explore the number of daily cases per million population in different countries. You can also highlight a country by hovering over or tapping the legend text (at the bottom of the plot) associated with that country.
...
***
Where do we stand globally in terms of the percentage of population fully vaccinated against COVID-19? Vaccination data for each country shown are last provided either on the date shown at the bottom of the map or the day before it. Hover your cursor over or tap a country of interest to see the data corresponding to that country. Remember you can zoom in and out of the map. Panning will be enabled when the map is zoomed in.
...
***
Certain countries (including Malaysia) and global average are colour-coded, while others are grey. Each bubble represents a country, with its radius corresponding to the size of that country. Hover your cursor over or tap the bubbles to explore the percentage of population fully vaccinated in different countries. You can also highlight a country by hovering over or tapping the legend text (at the bottom of the plot) associated with that country. Vaccination data for each country shown are last provided either on the date shown at the top of the plot or the day before it.
