...
output: 
  flexdashboard::flex_dashboard:
    ...
    navbar:
          ...
          - {title: "Source code", icon: "fa-file-code", href: "https://github.com/fyii200/www.malaysiacovid.com/blob/main/index.Rmd", align: right}
    social: menu
    fig_mobile: FALSE
...
```{r echo=FALSE, fig.height=5.5, fig.width=7, warning=FALSE}
# configure data frame for highcharter
data <- subset(daily_dose, select = c(date, dose1, dose2) 
               )
...
<span style="font-size:1em; color:`r col[1]`;"> **+`r dose1_7day_avg_formatted`**</span>  
...
<span style="font-size:1em; color:`r col[2]`;"> **+`r dose2_7day_avg_formatted`**</span>  
...
```{r echo=FALSE, fig.height=6, fig.width=7, warning=FALSE}
# Plot map (new cases per million)
plot_map_vac_per_hundred(dataset = vac,
                           mapsource = "custom/world-highres")
```
