...
hc_caption( text = ' Bubble size corresponds to vaccination rate.' )    %>%
...
hc_plotOptions( packedbubble = list( minSize = '20%', maxSize = "150%", 
                                     layoutAlgorithm = list( bubblePadding = 15 ) )
              )                                                                               %>%
