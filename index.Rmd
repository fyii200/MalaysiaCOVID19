...
output: 
  flexdashboard::flex_dashboard:
    ...
    social: menu
    fig_mobile: FALSE
date: <span style="font-size:0.7em;"> updated on&nbsp; </span> <span style="font-size:0.9em;">`r format(Sys.Date(), '%d %b %Y')` </span>
---
...
<span style="font-size:1.3em; color:`r col[2]`;"> **`r lastweeknew`** </span> <span style="font-size:1em; color:grey;"> **cases / day** </span>  
<span style="color:grey;"> *7-day average for the week ending `r lastlastdate`.* </span>

<span style="font-size:1.3em; color:`r col[2]`;"> **`r weeknew`** </span> <span style="font-size:1em; color:grey;"> **cases / day** </span>   
