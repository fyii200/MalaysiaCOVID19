...
Daily summary {data-icon="fa-table" .no-mobile}
=========================================
...
<span style="font-size:2.5em; color:`r col[2]`;"> **+`r dailynew`** </span>  
...
<span style="font-size:2.5em; color:`r col[1]`;"> **`r latest_tests`** </span>  
...
<span style="font-size:2.5em; color:`r col`;"> **`r latest_pr`%** </span>  
...
<span style="font-size:2.5em; color:`r col`;"> **`r format(max(y, na.rm=T), scientific=F, big.mark=',')`** </span>  
...
<span style="font-size:2.5em; color:`r col[2]`;"> **+`r death7avg`** </span>  
...
<span style="font-size:2.5em; color:`r col[2]`;"> **`r cfr`%** </span>  
...
<span style="color:`r col[2]`; font-size:2.5em;">**`r cum_deaths`**</span> 
...
### <span style="font-size:1.3em;"> **Percentage Vaccinated |** </span> <br> <span style="font-size:0.9em;"> What share of the population has been vaccinated? </span>
```{r echo=FALSE, fig.height=3, fig.width=6, warning=FALSE, fig.align='left'}
# configure data frame for dygraph
...
<span style="font-size:2.5em; color:`r col[3]`;"> **`r round(max(y1), 1)`%** </span>  
<span style="color:grey;"> *have received at least 1 dose of a vaccine.* </span>

<span style="font-size:1.5em; color:`r col[3]`;"> **+ `r inc1`%** </span>  
<span style="color:grey;"> *from `r format(d$date[length(d$date)-1], '%d %b')`* </span>

_____________________  

<span style="font-size:2.5em; color:`r col[2]`;"> **`r round(max(y2), 1)`%** </span>  
<span style="color:grey;"> *have received at least 2 doses of a vaccine.* </span>  

<span style="font-size:1.5em; color:`r col[2]`;"> **+ `r inc2`%** </span>  
<span style="color:grey;"> *from `r format(d$date[length(d$date)-1], '%d %b')`* </span>
...
<span style="font-size:2.5em; color:`r col[1]`;"> **`r format(max(y1), scientific=F, big.mark=',')`** </span>  
<span style="color:grey;"> *first doses have been administered.* </span>

_____________________  

<span style="font-size:2.5em; color:`r col[2]`;"> **`r format(max(y2), scientific=F, big.mark=',')`** </span>  
...
<span style="font-size:2.5em; color:`r col[3]`;"> **`r dailydose1`** </span>
<span style="color:grey;"> *first doses* </span>  

<span style="font-size:2.5em; color:`r col[2]`;"> **`r dailydose2`** </span>
